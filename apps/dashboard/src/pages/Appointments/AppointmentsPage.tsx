...
export function AppointmentsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Setup CTA — shown when there are no appointments yet */}
      {!isLoading && appointments.length === 0 && (
        <div className="flex items-center gap-4 px-5 py-4 bg-indigo-950/40 border border-indigo-500/30 rounded-xl">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-white">No scheduling flow yet</p>
            <p className="text-xs text-slate-400 mt-0.5">Set up a scheduling flow so buyers can book appointments directly via WhatsApp.</p>
          </div>
          <Link
